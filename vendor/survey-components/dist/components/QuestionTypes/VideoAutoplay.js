...
const VideoAutoplay = ({ question, onComplete, disabled = false }) => {
    ...
    const buildIframeUrl = useCallback((opts) => {
    ...
    }, [question, onComplete, disabled, buildIframeUrl]);
    ...
    return (React.createElement(Container, null,
        React.createElement(VideoWrapper, null, question.videoAskId ? (React.createElement(React.Fragment, null,
            React.createElement(VideoAskIframe, { ref: iframeRef, src: iframeUrl, 
                // Always omit autoplay permission for intro; we load it paused
                loading: "lazy", referrerPolicy: "strict-origin-when-cross-origin", allow: 'encrypted-media; fullscreen; display-capture', title: "Welcome video from Amanda", onLoad: () => {
                    if (process.env.NODE_ENV === 'development') {
            ...
            React.createElement(Video, { ref: videoRef, src: question.videoUrl, controls: true, onEnded: () => handleCompletion('watched'), playsInline: true, loop: false }),
            showPlayButton && (React.createElement(PlayButtonOverlay, { onClick: handlePlayClick },
                React.createElement(PlayButton, null, "\u25B6\uFE0F")))))),
        !disabled && (React.createElement(ButtonsRow, null,
            React.createElement(SkipButton, { onClick: handleSkipClick }, "Skip Video \u2192"),
            showContinue && (React.createElement(ContinueButton, { onClick: () => handleCompletion('watched') }, "Continue \u2192"))))));
};
...
//# sourceMappingURL=VideoAutoplay.js.map
